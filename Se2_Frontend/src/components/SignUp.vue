            ...
            <div class="page-signup">                
                <div class="row form-signup">
                    <div class="col-12 col-sm-8 col-md-8">
                        <h2 class="text-cr-acc">Create an account</h2>
                                ...
                                <div class="content-input">
                                    <form action="" class="form-common">
                                        <div class="field-form-wr clearfix">
                                            ...
                                            <div class="field field-half fix-size ">
                                                <div class="field-input-wr">
                                                    <input type="tel" name="" id="" placeholder="Mobile" class="form-control">
                                                </div>
                                            </div>
                                            <div class="field field-half fix-size ">
                                                <div class="field-input-wr">
                                                    <select name="country" class="col col-half form-control" id="country">
                                        ...
                                        <div class=" row two-checkbox">
                                            <div class="input checkbox required">
                                                ...
                                                <label><span>I have read and agree to the <a href="" class="">Terms & Conditions.</a></span></label>
                                            </div>
                    ...
                    <div class="col-12 col-sm-4 col-md-4 ml-auto ">
                        <div class="mt-5 alred-acc-panel">
                            <div class="signin-form-wr">
                                <h4 class="go-to-signin">Already have an account?</h4>
                                <p class="margbottom15">
                                    Sign in to your account to track your orders, manage your
                                    addresses and check gift card amounts.
                                </p>
                                <a href="" class="btn btn-outline-primary btn-outline">Sign In</a>
                            </div>
                        </div>
                    </div>
                </div>
...
.sign-form-wr .btn-outline, .btn-outline-primary{
    border-color: #E58C82;
    color:#E58C82;
}
