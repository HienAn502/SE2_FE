<template>
  <div class="text-center category-banner">
      <img src="http://victoria.shopaccino.com/uploads/victoria/categories/ban-855802_l.jpg" alt="Rings" class="img-fluid" /> 
  </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div class="text-center mb-3 heading"><h2>Necklace</h2></div>
        </div>
