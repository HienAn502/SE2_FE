<template>
    <div class="text-center category-banner">
        <img src="http://victoria.shopaccino.com/uploads/victoria/categories/braclet-ban-468447_l.jpg" alt="Rings" class="img-fluid" /> 
    </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="text-center mb-3 heading"><h2>Bracelets</h2></div>
          </div>
